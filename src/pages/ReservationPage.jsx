          ...
          <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8 h-full">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div className="mt-6 flex flex-col gap-1 text-center" >
                <Link to={"/event/checkout/"} state={{ reservationData: reservation, eventData: event }} className="w-full bg-(--primary-color) text-white font-bold py-3 px-4 rounded-lg  hover:bg-red-700 transition-colors">Pagar</Link>
                <button onClick={handleCancelClick} className="cursor-pointer w-full bg-gray-600 text-white font-bold py-3 px-4 rounded-lg  hover:bg-gray-500 transition-colors">
                  Cancelar
                </button>
              </div>
            </div>
